...
@section('frontendContent')
    ...
    <div class="waxon_tm_portoflio" id="portfolio_videos">
        <div class="container">
            <div class="waxon_tm_main_title">
                <div class="title">
                    <h3>Featured Works (Videos)<span class="bg">Portfolio</span></h3>
                </div>
                <div class="portfolio_filter">
                    <ul>
                        ...
                        @foreach ($video_playlist as  $playlist)
                            <li>
                                <a data-filter=".{{ $playlist->playlist_title }}">
                                    <span class="first">{{ $playlist->playlist_title }}</span>
                                    <span class="second">{{ $playlist->playlist_title }}</span>
                                </a>
                            </li>
                        @endforeach
            ...
            <div class="portfolio_inner">
                <ul class="gallery_zoom">
                    @foreach ($video_info as $videos)
                        <li class="{{ $videos->onePlaylist->playlist_title }} every">
                            <div class="list_inner">
                                <div class="image">
                                    <img src="{{ url('./storage/video' . '/' . $videos->image_name) }}" alt="" />
                                    <div class="main" data-img-url="{{ url('./storage/video' . '/' . $videos->image_name) }}"></div>
                                    <a class="full_link popup-youtube" href="{{ $videos->video_link }}"></a>
                                </div>
                                <div class="title">
                                    <h3><a href="#">{{ $videos->video_name }}</a></h3>
                                    <span><a href="#">{{ $videos->onePlaylist->playlist_title }}</a></span>
                                </div>
                            </div>
                        </li>
                        {{-- <li class="image">
